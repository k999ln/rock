...
export default function PreviewGuide() {
  return <main className={styles.page}>
    ...
    <article className={styles.guide}>
      ...
      <div className={styles.notice}><strong>配布候補を検証中です。</strong><p>これは現在の操作手順です。製品ライセンスは未確定で、一般公開の配布は未開始です。受入と公開条件の確認後に案内する配布記録で、ダウンロードURL、版とファイルのハッシュを確認してください。</p></div>
