...
export default function PreviewGuide() {
  return <main className={styles.page}>
    <header className={styles.header}><Link href="/" className={styles.brand} aria-label="ホームへ戻る">{PRODUCT_NAME}<span>{PRODUCT_VERSION}</span></Link><Link href="/rockstaros">開発版の案内へ</Link></header>
    ...
    <footer className={styles.footer}><span>{PRODUCT_PREVIEW_NAME}</span><Link href="/rockstaros">開発版の案内へ戻る ↗</Link></footer>
  </main>;
}
