...
export const operatorManagedDevices = sqliteTable(
  'operator_managed_devices',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [
    index('idx_operator_devices_status_seen').on(
      table.status,
      table.lastSeenAt,
    ),
    index('idx_operator_devices_owner').on(table.ownerUserId, table.createdAt),
  ],
);
export const operatorDeviceCommands = sqliteTable(
  'operator_device_commands',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [
    index('idx_operator_commands_device_status').on(
      table.deviceId,
      table.status,
      table.issuedAt,
    ),
    index('idx_operator_commands_incident').on(
      table.incidentId,
      table.issuedAt,
    ),
  ],
...
export const operatorAuditEvents = sqliteTable(
  ...
  (table) => [
    index('idx_operator_audit_device_created').on(
      table.deviceId,
      table.createdAt,
    ),
    index('idx_operator_audit_incident_created').on(
      table.incidentId,
      table.createdAt,
    ),
  ],
