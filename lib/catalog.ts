...
export const catalog: Automation[] = [
  {
    ...
    name: 'Rockstar Market Scanner',
    category: '市場・商品設計',
    description:
      '型付きの価値対象をRockstar Marketへ登録し、価格・需要・PAPER取引履歴を検証します。',
  ...
  {"id":"rockstar-ledger","name":"サブスク顧問","category":"経費・契約管理","description":"契約、更新日、支払い失敗を一元管理。カード明細から定期課金候補も見つけます。","source":"https://github.com/k999ln/rock/tree/codex/sky-rockstar-ledger-20260912/toolkits/rockstar-ledger","runner":"subscription-ledger","environment":"PC接続 / ローカル台帳","cost":"追加API料金なし。契約データと明細はPC内のSQLiteに保存し、Skyは読み取り専用で接続します。","steps":["Rockstar LedgerをPCへ展開する","Python 3.10以上でローカル台帳を起動する","Skyでサブスク顧問を開き、接続状態を確認する","要対応と更新予定を確認し、変更は本人が各契約先で行う"],"note":"Skyは契約状況の確認を支援します。解約、支払い、税務申告を自動実行せず、通貨も勝手に合算しません。","color":"green","license":"MIT","licenseUrl":"/toolkits/rockstar-ledger-LICENSE.txt","status":"ready","origin":"rockstaros"},
  {
