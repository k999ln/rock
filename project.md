...
| DOC04 | avokado READMEをR5現行製品・事業・機能と全設計書の入口へ刷新し、図面準拠の構想画像とブランドGIFを追加 | 完了 | [記録](README.md) · [記録](docs/brand/avokado/avocado-mini-r5-concept.png) · [記録](docs/brand/avokado/avokado-motion.gif) · [記録](data/design-document-index.json) · [記録](docs/avocado-mini-r5/package/package_manifest.json) |
