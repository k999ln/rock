...
現在の機械可読進捗は108 task中77 done、22 in progress、8 planned、1 blocked。件数は作業量や製品完成率を表さない。
...
| [Product / UX](01-product-ux.md)                                       | 製品要件、Home、Zema、Studio、画面設計       | RQ01〜RQ47と全体構成監査、実利用の不便削減  |
