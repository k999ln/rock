...
- 利用者提供のMotion Tower P0.2設計書を公開製品ページの優先基準に採用。4本＋Edge Hubのキット、税込41万円のキット目標、自立1.2m／ドック検出時1.8m、各塔3カメラ、外部AR表示、安全制御境界へ文言と構想レンダリングを更新。Appleの製品紹介の章立てを参考に、全画面ヒーロー、横送りハイライト、タワー1本の全周回転、価格、OS導入の順とする。提供PDF自体は公開sourceに含めない。
