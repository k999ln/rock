...
同時期にmainへ追加された[OS設計書完全版 v1.0](../rockstaros-complete-design-v1.0.pdf)も原本のまま保持します。同書p4・17・30のE3「4本＋別Hub」配置はR5へ適用せず、OS共通運用設計とのDevice Profile・adapter統合は未完了です。
