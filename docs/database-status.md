...
- 作業進捗: 163 task中 107 done、33 in progress、18 planned、5 blocked
...
| Android Work Engine SQLite | Android work・artifact・run・event | 15 | VERIFIED | EMULATOR_SCOPED | 未確認 | 未確認 |
...
<details><summary>Android Work Engine SQLite: 15 table</summary>

`artifacts`、`events`、`model_journal`、`model_meta`、`model_pins`、`model_pointer`、`model_profiles`、`outbox_events`、`outbox_meta`、`outbox_operations`、`rock_meta`、`runs`、`settings`、`sky_selection`、`works`
