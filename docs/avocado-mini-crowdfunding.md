...
**考える時間を、つくる時間に。** avocadoMiniの希望参考価格は**41万円**です。これは将来の製品像を検討するための目安であり、支援額、予約価格、確定販売価格ではありません。高性能LLMを搭載するRockstarOSを目指しますが、製品版への搭載と性能は実機で未検証です。
...
実験結果や性能を確かめる前に、完成品、発送日、確定販売価格を約束しません。41万円は希望参考価格です。無料配布の対象とOS従量課金の条件も未確定です。
