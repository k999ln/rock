...
**既存設計の実装は承認済みです。** 承認記録、`docs/os-sky-wallet-game-design.md`、`docs/rockstaros-1.0-strategy.md`を参照します。8原則の対象市場・代表商品・pilot目標は検証仮説であり、確定要望へ勝手に置換しません。未決の実ゲーム・交換方向・本番条件は推測しません。
