...
r={'schema':'rock-final-linux-readonly-closure/1','started_utc':datetime.datetime.now(datetime.timezone.utc).isoformat(),'status':'FAIL'}
try:
    ...
    assert not extra_files,extra_files
    ...
    r.update(source_commit=frozen['source_commit'],source_files_verified=1364,extra_source_files=extra_files,source_mismatches=mismatches,freeze_sha256=freeze_sha,profile_sha256=profile_sha,image_sha256=triple)
