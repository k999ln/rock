...
root=Path('/Users/kaiya/Library/RockstarOS/rls01-final1');env=dict(os.environ,LIMA_HOME=str(root/'lima'))
...
observed=[]
a=run(['python3','work/preview-final1-download/preview.py','start','--directory',str(root)])
...
Path('work/final1-pending-guards.json').write_text(json.dumps(report,indent=2)+'\n')
