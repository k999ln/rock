...
root=Path('/var/tmp/rockstaros-auditors-game1/closed-ui')
sys.path.insert(0,'/opt/rockstaros-preview/native/src')
...
with backup.locked(source),backup.locked(target):
    ...
    print(json.dumps({'schema':'rockstaros-preview-game-readback/1','status':'OBSERVED','supplemental_read_clock_compare':original_comparison,
      'scope':'supplemental 7c5b41a stopped disk audit only; original 8bd comparison FAIL is retained separately',
