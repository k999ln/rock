...
base=Path('/var/tmp/rock-final-9abf78a/systems/rock-star-os');failed=Path('/var/tmp/rock-final-c-9abf78a-continuation-03/citations');out=Path('/var/tmp/rock-final-c-equivocation-recovery-normal-close-03');out.mkdir(mode=0o700,exist_ok=False)
...
try:
 ...
 driver.wait('電源を切る',label='actual-device-page-after-prior-delayed-navigation')
 driver.native.click(113,910);time.sleep(.5);driver.native.capture('hub-before-original-catalog-refresh')
