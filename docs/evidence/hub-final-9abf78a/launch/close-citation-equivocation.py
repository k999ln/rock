...
base=Path('/var/tmp/rock-final-9abf78a/systems/rock-star-os');failed=Path('/var/tmp/rock-final-c-9abf78a-continuation-03/citations');out=Path('/var/tmp/rock-final-c-equivocation-normal-close-01');out.mkdir(mode=0o700,exist_ok=False)
