...
![RETURN-1 C3 外観意匠図](RETURN-1_C3_external_concept.png)
...
![機能配置図。寸法・タンク境界・翼面形状を定義する製造図ではない。](RETURN-1_C3_functional_layout.svg)
...
![仮定からの理想速度増分。横軸の起点は8,500 m/s。帰還成立の確認は含まない。](RETURN-1_C3_mass_comparison.svg)
