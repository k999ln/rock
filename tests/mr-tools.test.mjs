...
void test('citation URLs deduplicate and merge before the next section',()=>{
...
void test('citation formatting preserves fenced code, inline code and non-link sources',()=>{
...
void test('article input rejects open code, invalid price, summary and URL',()=>{
...
void test('coconala rules distinguish optional calls, missing evidence and required presence',()=>{
...
void test('browser matches the original eligibility module on a standalone example',()=>{
...
void test('Python free-edition adapter agrees with browser result and does not log article excerpts',()=>{
...
void test('standalone citation adapter agrees with browser and cannot overwrite input',()=>{
...
void test('delivery evidence passes, self-review is blocked, changed artifacts are blocked',()=>{
