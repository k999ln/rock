...
test('fund cash is conserved through fees, member payouts and reserves',()=>{
...
test('boosts never become revenue, even with no income or unrecovered costs',()=>{
...
test('unsupported boost and rounding are reserved; boost share is bounded and monotone',()=>{
...
test('invalid financial assumptions and fictional other members are rejected',()=>{
