...
- Skyの「日本語法律相談受付」で、安全・期限・相談分野をブラウザ内だけで整理。一般情報で足りる場合は公的案内、弁護士相談が必要な場合だけ引継ぎ要約と日本語対応候補を表示します。法的助言や自動連絡は行わず、相談本文は保存しません。[実装と安全境界](docs/sky-legal-intake-20260912.md)
